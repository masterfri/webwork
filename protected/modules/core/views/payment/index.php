...
$this->pageHeading = Yii::t('core.crud', 'Manage Payments');

$this->breadcrumbs = array(
	Yii::t('core.crud', 'Payments'), 
);
...
<div class="panel panel-default">
	...
	<?php $this->widget('GridView', array(
		...
		'columns' => array(
			...
			array(
				'class' => 'ButtonColumn',
				'deleteConfirmation' => Yii::t('core.crud', 'Are you sure you want to delete this payment?'),
				'template' => '{view}'.
