...
$this->pageHeading = Yii::t('core.crud', 'New Milestone');
...
$this->breadcrumbs = array(
	...
	Yii::t('core.crud', 'Milestones') => Yii::app()->user->checkAccess('view_milestone', array('project' => $project)) ? array('index', 'project' => $project->id) : false, 
