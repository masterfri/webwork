...
$this->pageHeading = Yii::t('core.crud', 'Report Time for: {task}', array(
	'{task}' => CHtml::encode($task->name),
));

$this->breadcrumbs = array(
	Yii::t('core.crud', 'Daily Time Report') => Yii::app()->user->checkAccess('daily_time_report') ? array('daily') : false, 
	Yii::t('core.crud', 'New Time Report'),
);
...
$this->menu = array(
	...
	array(
		...
		'linkOptions' => array(
			'title' => Yii::t('core.crud', 'Daily Time Report'), 
			'class' => 'btn btn-default',
		), 
		'url' => array('daily'),
