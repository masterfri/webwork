...
$this->pageHeading = Yii::t('core.crud', 'New Task');
...
$this->breadcrumbs = array(
	...
	Yii::t('core.crud', 'Tasks') => Yii::app()->user->checkAccess('view_task', array('project' => $project)) ? array('index', 'project' => $project->id) : false, 
