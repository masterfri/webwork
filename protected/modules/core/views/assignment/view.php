...
$this->pageHeading = Yii::t('core.crud', 'Member Information');
...
$this->breadcrumbs = array(
	...
	Yii::t('core.crud', 'Team') => Yii::app()->user->checkAccess('view_assignment', array('project' => $model->project)) ? array('index', 'project' => $model->project->id) : false, 
);
...
$this->menu = array(
	...
	array(
		...
		'items' => array(
			array(
				'label' => '<i class="glyphicon glyphicon-pencil"></i> ' . Yii::t('core.crud', 'Update Member'), 
				'url' => array('update', 'id' => $model->id),
				'visible' => Yii::app()->user->checkAccess('update_assignment', array('assignment' => $model)),
			),
			array(
				'label' => '<i class="glyphicon glyphicon-trash"></i> ' . Yii::t('core.crud', 'Delete Member'), 
				'url' => '#', 
				'linkOptions' => array(
					'submit' => array('delete', 'id' => $model->id),
					'confirm' => Yii::t('core.crud', 'Are you sure you want to delete this member?'),
				),
