...
$this->pageHeading = Yii::t('core.crud', 'Activity Information');

$this->breadcrumbs = array(
	Yii::t('core.crud', 'Activities') => Yii::app()->user->checkAccess('view_activity') ? array('index') : false, 
);
...
$this->menu = array(
	...
	array(
		...
		'linkOptions' => array(
			'title' => Yii::t('core.crud', 'Manage Activities'), 
			'class' => 'btn btn-default',
		),
		'url' => array('index'),
	...
	array(
		...
		'items' => array(
			array(
				'label' => '<i class="glyphicon glyphicon-pencil"></i> ' . Yii::t('core.crud', 'Update Activity'), 
				'url' => array('update', 'id' => $model->id),
				'visible' => Yii::app()->user->checkAccess('update_activity'),
			),
			array(
				'label' => '<i class="glyphicon glyphicon-trash"></i> ' . Yii::t('core.crud', 'Delete Activity'), 
				'url' => '#', 
				'linkOptions' => array(
					'submit' => array('delete', 'id' => $model->id),
					'confirm' => Yii::t('core.crud', 'Are you sure you want to delete this activity?'),
				),
