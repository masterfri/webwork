...
$this->breadcrumbs = array(
	...
	Yii::t('admin.crud', 'Milestone') => Yii::app()->user->checkAccess('view_milestone') ? array('index', 'project' => $model->project->id) : false, 
);
...
$this->menu = array(
	...
	array(
		...
		'visible' => Yii::app()->user->checkAccess('update_milestone'),
	),
	array(
		...
		'visible' => Yii::app()->user->checkAccess('delete_milestone'),
	),
	array(
