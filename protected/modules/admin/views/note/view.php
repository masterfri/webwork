		...
		<div class="panel-heading">
			...
			<div class="actions">
				...
				<?php if(Yii::app()->user->checkAccess('delete_note', array('note' => $data))): ?>
					<a href="<?php echo $this->createUrl('note/delete', array('id' => $data->id)); ?>" data-raise="ajax-request" data-method="POST" data-confirmation="<?php echo Yii::t('admin.crud', 'Are you sure you want to delete this note?')?>"><span class="glyphicon glyphicon-remove"></span></a>
				<?php endif; ?>
			</div>
		</div>
